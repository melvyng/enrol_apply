...
class enrol_apply_plugin extends enrol_plugin {
    ...
    public function enrol_page_hook(stdClass $instance) {
		...
		if(preg_match('/@iadb.org$/', strtolower($USER->email))){
        ...
        if ($data = $form->get_data()) {
            ...
            if ($data->instance == $instance->id) {
				...
				//Melvyn Gomez, las 3 lineas anteriores yo la comente 9/20/2018 OpenRanger S. A. de C.V.
        ...
        return $OUTPUT->box($output);
			...
			return $OUTPUT->box(get_string('notification_no_bid', 'enrol_apply'), 'notifywarning');
		}
    }
