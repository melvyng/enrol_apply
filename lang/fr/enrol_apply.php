...
$string['enrolname'] = 'Employés BID';
$string['pluginname'] = 'Employés BID';
...
$string['notification_no_bid'] = '<b>Vous ne pouvez pas vous inscrire à ce cours</b>. <br/><br/>Ce cours est fermé uniquement pour les employés de la BID.';
