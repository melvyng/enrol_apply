...
$string['enrolname'] = 'IDB Employees';
$string['pluginname'] = 'IDB Employees';
...
$string['notification_no_bid'] = '<b>You can not enrol yourself in this course</b>. <br/><br/>This course is closed, only for IDB employees.';
