...
$string['enrolname'] = 'Funcionários do BID';
$string['pluginname'] = 'Funcionários do BID';
...
$string['notification_no_bid'] = '<b>Você não pode se matricular neste curso</b>. <br/><br/>Este curso está fechado, apenas para funcionários do BID.';
