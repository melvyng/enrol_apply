...
$string['enrolname'] = 'Empleados BID';
$string['pluginname'] = 'Empleados BID';
...
$string['notification_no_bid'] = '<b>No se puede matricular en este curso</b>. <br/><br/>Este curso es cerrado, solamente para empleados del BID.';
